...
export const RECURSOS_FINANCIERA: DocRecurso[] = [
    ...
    columnas: {
      ...
      origen_contable: {
        ...
        valores: {
          ...
          solo_contable: "Costo contable cargado sin operación en GEMA: cero viajes e ingresos; cuenta como cubierto",
  ...
  // ── vw_financiera_flota_mes ────────────────────────────────────────────────
  {
    ...
    columnas: {
      ...
      vehiculos: { descripcion: "Vehículo-mes con operación o costo contable en el mes.", unidad: "vehículos" },
      vehiculos_activos: { descripcion: "De esos, cuántos siguen activos hoy en el maestro.", unidad: "vehículos" },
      vehiculos_con_contable: { descripcion: "Cuántos tienen costo contable o están cubiertos como sin_movimiento.", unidad: "vehículos" },
