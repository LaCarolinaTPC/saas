...
const ACCION_LABELS: Record<string, { label: string; bg: string; color: string }> = {
  ...
  usuario_editado: { label: "Usuario editado", bg: "#DBEAFE", color: "#2563EB" },
  cambio_rol: { label: "Cambio de rol", bg: "#FEF3C7", color: "#B45309" },
  cambio_permisos: { label: "Cambio de permisos", bg: "#FEF3C7", color: "#B45309" },
  rol_creado: { label: "Rol creado", bg: "#FEF3C7", color: "#B45309" },
  rol_editado: { label: "Rol editado", bg: "#FEF3C7", color: "#B45309" },
  rol_eliminado: { label: "Rol eliminado", bg: "#FEE2E2", color: "#DC2626" },
  ...
  // Matriz de ausentismo (RRHH). "Conductor" muestra al empleado y "Valor" los días perdidos.
  incapacidad_registrada: { label: "Incapacidad registrada", bg: "#D1FAE5", color: "#059669" },
  incapacidad_editada: { label: "Incapacidad editada", bg: "#FEF3C7", color: "#B45309" },
