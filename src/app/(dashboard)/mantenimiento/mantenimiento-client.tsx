...
type Reporte = { id: string; codigo_vehiculo: string; cedula_conductor: string; descripcion: string | null; fecha_reporte: string; alerta_id: string | null; vehiculos: { placa: string | null }[]; mantenimiento_conceptos: { nombre: string }[]; conductores: { nombre: string }[] };
type Alerta = { id: string; codigo_vehiculo: string; cantidad: number; created_at: string; vehiculos: { placa: string | null }[]; mantenimiento_conceptos: { nombre: string }[] };
