-- 029: Ampliar la whitelist de external_aggregate con los recursos GEMA y
-- procesos de contratación (los mismos agregados a EXTERNAL_RESOURCES en el
-- código): puntos_virtuales, viajes_recaudados, ingreso_tercero, propietarios
-- y procesos_contratacion. El resto de la función es idéntico a la 020.
...
DECLARE
  allowed_resources text[] := ARRAY[
    ...
    'puntos_virtuales','viajes_recaudados','ingreso_tercero','propietarios'
  ];
